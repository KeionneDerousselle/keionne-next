...
const Parallax: FC = () => {
  useLayoutEffect(() => {
    ...
    const parallaxInstance = new ParallaxJS(scene, {
      relativeInput: true,
    });
  ...
  return (
    <div id="parallax" className="absolute top-0 left-0 w-full h-full">
      <svg
        width="27"
        height="29"
        data-depth="0.3"
        className="overflow-hidden align-middle !left-[10%] !top-[10%]"
      ...
      <svg
        ...
        height="26"
        data-depth="0.2"
        className="overflow-hidden align-middle !left-[15%] !top-[30%] sm:!left-[25%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        ...
        height="25"
        data-depth="0.3"
        className="overflow-hidden align-middle !top-auto !left-[10%] !bottom-[30%] sm:!left-[15%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        ...
        height="23"
        data-depth="0.6"
        className="overflow-hidden align-middle !top-auto !left-[10%] !bottom-[10%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        ...
        height="23"
        data-depth="0.2"
        className="overflow-hidden align-middle !left-[45%] !top-[3%] sm:!top-[10%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
          transform="rotate(30 9.86603 10.13397)"
      ...
      <svg
        ...
        height="17"
        data-depth="0.5"
        className="overflow-hidden align-middle !top-auto !left-[40%] !bottom-[10%]"
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        ...
        height="26"
        data-depth="0.4"
        className="overflow-hidden align-middle !top-[20%] !right-[30%] !left-auto"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        ...
        height="21"
        data-depth="0.3"
        className="overflow-hidden align-middle !top-auto !right-[30%] !bottom-[30%] !left-auto"
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        ...
        height="25"
        data-depth="0.3"
        className="overflow-hidden align-middle !right-[10%] !top-[10%] !left-auto"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        ...
        height="29"
        data-depth="0.2"
        className="overflow-hidden align-middle !top-[45%] !right-[10%] sm:!right-[20%] !left-auto"
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        ...
        height="20"
        data-depth="0.5"
        className="overflow-hidden align-middle !top-auto !bottom-[10%] !right-[10%] !left-auto"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
...
const ScrollDown: FC = () => (
  <div className="absolute left-0 z-20 w-full bottom-10 scrolldown">
    <Link
      to="about"
      className="flex flex-col items-center m-auto text-sm text-center text-white cursor-pointer max-w-[100px]"
      hashSpy
      smooth
      offset={-56}
    >
...
export const Intro: FC<IntroProps> = ({ id, className }) => (
  <section
    ...
    className={classNames(
      'relative flex items-center h-screen min-h-screen bg-purple-600 pt-[300px] md:p-0',
      className
    )}
  >
