...
export const AnimatedScrollIndicator: FC<AnimatedScrollIndicatorProps> = ({ href }) => (
  <div className="absolute left-0 z-20 w-full bottom-10 scrolldown">
    <NextLink href={href} passHref>
      <a className="flex flex-col items-center m-auto text-sm text-center text-white cursor-pointer scale-100 hover:text-[#FFD15C] hover:font-bold hover:scale-110 focus:text-[#FFD15C] focus:font-bold transition-all duration-150 ease-in-out transform-gpu focus:scale-110 focus:outline-none max-w-[100px]">
